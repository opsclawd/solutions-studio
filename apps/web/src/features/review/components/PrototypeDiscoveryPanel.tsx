...
export interface PrototypeDiscoveryPanelProps {
  projection: ProjectionRecordDto;
  actorId?: string;
  onDiscoveryRecorded?: () => void | Promise<void>;
}

export function PrototypeDiscoveryPanel({
  projection,
  actorId,
  onDiscoveryRecorded
}: PrototypeDiscoveryPanelProps) {
  ...
  return (
    <div
      data-testid="prototype-discovery-panel"
      className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-xs mt-6 p-6"
    >
      <div className="mb-4">
        <h3 className="text-sm font-bold text-gray-900">Report Prototype Discovery</h3>
        <p className="text-xs text-gray-500 mt-0.5">
          Propose requirements or report findings discovered during interactive prototype review
        ...
        <form onSubmit={handleSubmitRequirement} className="space-y-4">
          <div>
            ...
            <textarea
              ...
              placeholder="e.g. System must provide inline confirmation modal for destructive action"
              rows={2}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Discovered missing confirmation barrier during prototype interaction"
        ...
        <form onSubmit={handleSubmitFinding} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="e.g. State transitions do not prevent submitting with invalid values"
              rows={2}
              className="w-full text-xs p-2.5 border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-hidden font-normal"
              required
            />
