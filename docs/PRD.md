...
* **FR-7.1:** Upon prompt (`/stories`), the engine shall generate user stories following standard Agile structure: *As a [Role], I want [Feature], so that [Business Outcome]*.
