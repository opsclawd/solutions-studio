...
| **Class B** | Long-term / Retained  | Engineering decisions, Stories, Projections                                                                 | PostgreSQL + Object Storage        | Retained for product lifecycle (minimum 7 years)                                                                                                     | Versioned / Append-only      | Tier 2 (Protected while linked to active Baselines)                           |
